...
// For NextAuth 4.x with App Router, we need to export a handler function
// that gets called for both GET and POST
const handler = NextAuth(authOptions);

// In Next.js 14, you export GET/POST as route handlers  
