...
export default function ToolCard({ title, slug, desc, updated }){
  return (
    <div className="flex flex-col bg-neutral-900 rounded-xl border border-white/10 transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.35)] animate-pop overflow-hidden">
      ...
      <div className="px-3 py-1.5 text-[11px] bg-black/20 text-gray-500 text-left border-t border-white/5">
        Last updated: {updated || 'Not available'}
      </div>
    </div>
  );
}
