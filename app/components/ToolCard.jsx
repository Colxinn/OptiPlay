...
export default function ToolCard({ title, slug, desc }){
  return (
    <div className="p-4 bg-neutral-900 rounded-xl border border-white/10 transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.35)] animate-pop flex flex-col h-full min-h-[160px]">
      ...
      <div className="flex gap-2 items-center mt-auto">
        ...
        <div className="ml-auto text-xs text-gray-500 whitespace-nowrap">Updated 2d</div>
      </div>
    </div>
  );
}
